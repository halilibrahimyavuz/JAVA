...
public class Q01 {
    ...
    public static void main(String[] args) {
     ...
     Scanner scan = new Scanner(System.in);
        ...
        int rakamlarınınKüpleriToplamı=0;
        int ilkdeger=sayi;

        while (sayi!=0){
            int rakam=sayi%10;
            rakamlarınınKüpleriToplamı+=rakam*rakam*rakam;
            sayi/=10;
        }
        if (rakamlarınınKüpleriToplamı==ilkdeger){
            System.out.println("gırılen sayı amstrong sayısıdır -->"+ilkdeger);
        }else{
            System.out.println("gırlen sayı amstrong sayısı degıldır");
        }
